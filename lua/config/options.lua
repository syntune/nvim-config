...
vim.opt.relativenumber = true -- Show line numbers relative in position
...
vim.opt.hlsearch = true -- Don't highlight search items by default
...
-- Remove that god-forsaken OSC52 delay
vim.g.clipboard = {
  name = 'OSC 52',
  copy = {
  ...
  paste = {
    -- Empty functions disable OSC 52 paste
    ['+'] = function() end,
    ['*'] = function() end,
  },
}   
